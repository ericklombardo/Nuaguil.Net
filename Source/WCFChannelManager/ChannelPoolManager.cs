...
namespace WCFChannelManager
{
    ...
    public sealed class ChannelPoolManager<TChannel>
        : ChannelManagerBase<TChannel>, IPoolableObjectFactory
    {
       ...
       public ChannelPoolManager(string endpointConfigurationName,string endPointAddressUri,string binding,string bindingConfiguration, IPoolFactory poolFactory)
       ...
       private IObjectPool CreatePool(IPoolFactory poolFactory)
        {
