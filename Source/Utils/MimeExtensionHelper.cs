...
namespace Nuaguil.Utils
{
   public static class MimeExtensionHelper
   {
      ...
      /// <summary>
      /// Verify that a mime type is register in the dictionary 
      /// </summary>
      /// <param name="extension"></param>
      /// <returns></returns>
      public static bool ContainMimeType(string extension)
      {
      ...
      {
         return _mimeTypes.ContainsValue(mimeType) ? _mimeTypes.First(x => x.Value == mimeType).Key : null;
      }
      ...
      public static string FindMimeType(string file, bool verifyFromContent=false)
      {
      ...
      public static string FindMimeByContent(string file, string proposedType=null)
      {
      ...
      [DllImport("urlmon.dll"
         ...
         , ExactSpelling = true
         , SetLastError = true)]
      private static extern Int32 FindMimeFromData(IntPtr pBC
