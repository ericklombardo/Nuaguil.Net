...
namespace Nuaguil.Utils.DesignByContract
{
    /// <summary>
    ...
    public sealed class Check
    {
       ...
       public static void RequireFormat(bool assertion, string message, params object[] objects)
       {
          Require(assertion,String.Format(message,objects),null);
       }

       public static void RequireFormat(bool assertion, Exception inner, string message, params object[] objects)
       {
          Require(assertion, String.Format(message, objects), inner);
       }
